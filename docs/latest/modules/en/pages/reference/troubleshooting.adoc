...
[source,bash]
----
helm upgrade -n cattle-ai-agent-system --set log.level=debug rancher-ai-agent rancher-ai/agent
----
...
[source,bash]
----
helm upgrade -n cattle-ai-agent-system --set insecureSkipTls=true rancher-ai-agent rancher-ai/agent
----
